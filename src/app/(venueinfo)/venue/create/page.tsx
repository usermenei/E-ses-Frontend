...
export default function CreateSpacePage() {
    ...
    const [formData, setFormData] = useState({
        ...
        postalcode: "",
        region: "",
        tel: "", // 👈 เปลี่ยนตรงนี้เป็น tel ให้ตรงกับ Database
        openTime: "08:00",
        closeTime: "18:00",
        picture: "",
        caption: "",
    ...
    return (
        ...
        >
            ...
            <div style={singleRowStyle}>
                ...
                <input 
                type="tel" 
                name="tel" // 👈 เปลี่ยนชื่อ name ให้ตรงกัน
                required 
                placeholder="e.g. 081-234-5678" 
                pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" // 👈 บังคับฟอร์แมต XXX-XXX-XXXX
                title="Please enter a valid phone number in the format XXX-XXX-XXXX" // 👈 ข้อความแจ้งเตือนถ้ากรอกผิด
                style={inputStyle} 
